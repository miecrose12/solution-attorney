...
// Images
import ehinomenImg from '../assets/associate.jpeg';   // ← Adjust path if your assets folder is elsewhere

// Data
const timeline = [
  { year: '2023', title: 'Graduated from Ambrose Alli University', description: 'Earned her Bachelor of Laws (LL.B) with Second Class (Upper Division) honors.' },
  { year: '2024', title: 'Nigerian Law School', description: 'Completed the Bar Part II program and was called to the Nigerian Bar.' },
  { year: 'Jul–Aug 2024', title: 'Legal Assistant, El-Bethel Law Firm', description: 'Gained hands-on experience in legal writing, client interviews, research, and courtroom support.' },
  { year: 'Aug 2025 – Present', title: 'Associate Counsel Solution Attorneys', description: 'Leads chamber operations, represents clients in court, drafts pleadings and contracts.' },
];
...
const coreExpertise = [
  ...
  { title: 'Entertainment & IT Law', description: 'Navigating contracts, intellectual property, and regulatory issues in entertainment and tech.' },
  { title: 'Regulatory Compliance & Energy Law', description: 'Advising on compliance frameworks and energy-sector regulations.' },
  { title: 'General Practice', description: 'Versatile counsel in consumer law, bankruptcy, criminal defense, and dispute resolution.' },
];

export default function EhinomenProfile() {
  return (
    <div className="bg-[#FCFCFA] min-h-screen font-sans text-slate-800 selection:bg-[#BFA84E]/20 relative overflow-hidden">
          ...
          <div className="flex-1 space-y-8">
            <div className="flex items-center gap-4">
              ...
              <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#BFA84E]">
                Associate Counsel &amp; Head of Chambers
              </span>
            </div>
            
            <h1 className="font-serif text-5xl sm:text-6xl lg:text-[5.5rem] font-medium leading-[1.05] text-slate-900 tracking-tight">
              Ehinomen <br /> Musa-Agboneni
            </h1>
            
            <p className="text-lg md:text-xl font-light leading-relaxed text-slate-600 max-w-lg">
              BL (Hons) | LL.B (Hons) — The Babygirl Lawyer.<br />
              Dynamic general practitioner specializing in regulatory compliance, energy law, entertainment law &amp; asset management.
            </p>
        ...
        <section className="mb-32 relative">
          <div className="max-w-3xl">
            ...
            <div className="space-y-6 text-slate-600 font-light text-lg leading-relaxed border-l border-[#BFA84E]/30 pl-6 lg:pl-8">
              <p>
                Ehinomen Musa-Agboneni is a rising star in Nigeria’s legal profession — affectionately known as “The Babygirl Lawyer.”
              </p>
              <p>
                After earning her LL.B with Second Class (Upper Division) from Ambrose Alli University and completing Nigerian Law School in 2024, she quickly gained practical experience at El-Bethel Law Firm.
              </p>
              <p>
                She now serves as Associate Counsel and Head of Chambers at Solution Attorneys, delivering bold, precise, and result-driven legal solutions across corporate, family, entertainment, energy, and regulatory matters.
              </p>
              <p>
                Connect with her:<br />
                Email: <span className="font-medium">babygirllawyer@gmail.com</span><br />
                TikTok: <span className="font-medium">@Thebabygirllawyer</span><br />
                Instagram: <span className="font-medium">@Thebabygirllawyer</span><br />
                LinkedIn: <span className="font-medium">Ehinomen Musa-Agboneni</span>
              </p>
            </div>
          </div>
        </section>
      ...
      <section className="bg-slate-900 py-24 px-6 text-center relative overflow-hidden">
        ...
        <p className="text-slate-400 font-light mb-12 max-w-xl mx-auto leading-relaxed">
          Connect with Ehinomen for strategic legal consultation in corporate, family, entertainment, energy, or regulatory matters.
        </p>
